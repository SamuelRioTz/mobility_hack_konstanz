...
import 'package:mobility_hack_konstanz/custom_layers/local_json_layer/markers_from_assets.dart';
...
class Layer extends CustomLayer {
  ...
  Future<void> load() async {
    ...
    customMarkers = await markersFromAssets("assets/resources/$fileName");
